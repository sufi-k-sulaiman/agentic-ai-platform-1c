...
export const SITE_URL = 'https://1cplatform.base44.app';
...
export function getOgImage(pageName) {
  const img = ogImages[pageName];
  if (!img || img.includes('unsplash.com')) return DEFAULT_OG_IMAGE;
  return img;
}
...
export const seoPages = {
  ...
  BlogAgenticAIContextManagement: { pageName: 'BlogAgenticAIContextManagement', title: 'Context Window Management in Agentic AI: Strategies and Techniques', description: 'Master context window management for AI agents. Learn token optimization, context compression, sliding windows, and long-term memory strategies for production systems.', url: '/BlogAgenticAIContextManagement', category: 'blog', keywords: ['context window', 'token management', 'context compression', 'AI memory', 'agentic AI context', 'sliding window'] },
  ...
  BlogAgenticAIErrorHandling: { pageName: 'BlogAgenticAIErrorHandling', title: 'Error Handling and Recovery in Agentic AI Systems', description: 'Build resilient AI agents with proper error handling. Retry strategies, fallback patterns, circuit breakers, and graceful degradation techniques for production AI systems.', url: '/BlogAgenticAIErrorHandling', category: 'blog', keywords: ['error handling', 'AI resilience', 'retry strategies', 'circuit breakers', 'fallback patterns', 'agent recovery'] },
  ...
  BlogAgenticAIObservability: { pageName: 'BlogAgenticAIObservability', title: 'Observability for Agentic AI: Monitoring, Debugging, and Optimization', description: 'Implement comprehensive observability for AI agents. Logging, tracing, metrics, dashboards, and debugging tools for production AI systems.', url: '/BlogAgenticAIObservability', category: 'blog', keywords: ['AI observability', 'agent monitoring', 'AI debugging', 'LLM tracing', 'agent metrics', 'production AI'] },
  ...
  BlogAgenticAIPromptEngineering: { pageName: 'BlogAgenticAIPromptEngineering', title: 'Prompt Engineering for Agentic AI: Techniques and Best Practices', description: 'Master prompt engineering for autonomous AI agents. System prompts, few-shot learning, chain-of-thought reasoning, and advanced techniques for production agents.', url: '/BlogAgenticAIPromptEngineering', category: 'blog', keywords: ['prompt engineering', 'system prompts', 'chain-of-thought', 'few-shot learning', 'AI prompts', 'prompt design'] },
  ...
  BlogAgenticAIScalability: { pageName: 'BlogAgenticAIScalability', title: 'Scaling Agentic AI: From Prototype to Production at Enterprise Scale', description: 'Learn strategies for scaling agentic AI systems. Load balancing, horizontal scaling, resource optimization, and multi-region deployment for enterprise AI.', url: '/BlogAgenticAIScalability', category: 'blog', keywords: ['AI scalability', 'agent scaling', 'load balancing', 'horizontal scaling', 'multi-region AI', 'enterprise AI scale'] },
  ...
  BlogAgenticAIToolIntegration: { pageName: 'BlogAgenticAIToolIntegration', title: 'Tool Integration in Agentic AI: APIs, Functions, and External Systems', description: 'Master tool integration for AI agents. API design, function calling, external system connectivity, and tool ecosystem management for autonomous agents.', url: '/BlogAgenticAIToolIntegration', category: 'blog', keywords: ['tool integration', 'API design', 'function calling', 'AI tools', 'agent APIs', 'external systems'] },
  ...
  AIOverview: { pageName: 'AIOverview', title: 'Artificial Intelligence: History, Invention, Pros & Cons, Status & Future', description: 'A comprehensive guide to Artificial Intelligence — its history, invention, advantages and disadvantages, current state in 2025, and what the future holds for AI technology.', url: '/AIOverview', category: 'resources', keywords: ['artificial intelligence', 'AI history', 'AI invention', 'AI pros and cons', 'AI future', 'AI current status', 'machine learning', 'deep learning', 'neural networks', 'AGI', 'AI overview'] },
  ...
  BlogEcommerceAIAutomation: { pageName: 'BlogEcommerceAIAutomation', title: 'How AI Is Transforming Ecommerce: From Personalization to Autonomous Operations', description: 'Discover how AI and agentic AI are revolutionizing ecommerce—from hyper-personalization and dynamic pricing to autonomous inventory management and AI-driven customer support.', url: '/BlogEcommerceAIAutomation', category: 'blog', keywords: ['ecommerce AI', 'AI automation ecommerce', 'agentic AI ecommerce', 'digital commerce AI', 'AI personalization', 'AI inventory management', 'AI dynamic pricing', 'ecommerce automation', 'autonomous ecommerce operations', 'AI customer support ecommerce'] },
  BlogDigitalCommerceStrategy: { pageName: 'BlogDigitalCommerceStrategy', title: 'Digital Commerce in 2025: Building AI-Powered Customer Journeys', description: 'A comprehensive guide to digital commerce strategy in 2025. Learn how AI agents power omnichannel experiences, headless commerce, composable architecture, and autonomous customer journeys.', url: '/BlogDigitalCommerceStrategy', category: 'blog', keywords: ['digital commerce', 'digital commerce strategy', 'AI customer journeys', 'omnichannel commerce', 'headless commerce', 'composable commerce', 'AI-powered commerce', 'digital transformation commerce', 'commerce architecture', 'conversational commerce'] },
  BlogTechTrendsEnterpriseAI: { pageName: 'BlogTechTrendsEnterpriseAI', title: 'Enterprise Technology Trends: How AI Agents Are Reshaping Digital Infrastructure', description: 'Explore the top enterprise technology trends of 2025. From AI agents and cloud-native architecture to edge computing and digital transformation, learn how autonomous AI is reshaping enterprise technology.', url: '/BlogTechTrendsEnterpriseAI', category: 'blog', keywords: ['enterprise technology trends', 'AI agents enterprise', 'digital infrastructure AI', 'cloud-native architecture', 'edge computing AI', 'enterprise AI transformation', 'technology trends 2025', 'AI infrastructure', 'digital transformation AI', 'enterprise AI'] },
  AuthorSufiKhanSulaiman: { pageName: 'AuthorSufiKhanSulaiman', title: 'Sufi Khan Sulaiman — CTO, 1C Platform | AI, Ecommerce & Digital Commerce Expert', description: 'Sufi Khan Sulaiman is Chief Technology Officer of 1C Platform and an expert in agentic AI, ecommerce, and digital commerce. Read his articles on AI automation, digital commerce strategy, and enterprise technology trends.', url: '/author/sufi-khan-sulaiman', category: 'company', keywords: ['Sufi Khan Sulaiman', 'Sufi K Sulaiman', '1C Platform CTO', 'AI author', 'ecommerce AI expert', 'digital commerce expert', 'agentic AI author', 'enterprise AI leader'] },
};
