...
import { Plane, Users, Clock, Shield, ArrowRight } from 'lucide-react';
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }}>
              ...
              <p className="text-xl text-gray-600 leading-relaxed mb-8">
                Optimize passenger flow, enhance security, and improve operational efficiency with AI-powered airport management.
              </p>
