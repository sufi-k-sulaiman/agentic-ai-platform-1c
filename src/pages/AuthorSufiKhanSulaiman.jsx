...
export default function AuthorSufiKhanSulaiman() {
  ...
  const personSchema = {
    ...
    url: `${typeof window !== 'undefined' ? window.location.origin : 'https://1cplatform.base44.app'}/author/sufi-khan-sulaiman`,
    image: AUTHOR.image,
    sameAs: [AUTHOR.url, AUTHOR.linkedin, 'https://1cplatform.base44.app'],
    worksFor: {
      '@type': 'Organization',
      name: '1C Platform',
